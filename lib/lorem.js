...
function ElSelect(selector) {
    ...
    const el = {
        ...
        AddGenerator: function () {
            ...
            ManageRegulators(element);
        }
    }
    element.AddGenerator = function(){
        el.AddGenerator();  
    };
    return el;
}
...
function ManageRegulators(item = null) {
    ...
    elementsThatHaveRegulator.forEach(item => {
        ...
        document.querySelector('div[data-requlatorId="' + attId + '"] .increaseParagraph').addEventListener('click', function () {
            RegulatorOperator('+', 'paragraph', loremLang, attId);
        });
        document.querySelector('div[data-requlatorId="' + attId + '"] .decreaseParagraph').addEventListener('click', function () {
            RegulatorOperator('-', 'paragraph', loremLang, attId);
        });
        document.querySelector('div[data-requlatorId="' + attId + '"] .increaseWords').addEventListener('click', function () {
            RegulatorOperator('+', 'word', loremLang, attId);
        });
        document.querySelector('div[data-requlatorId="' + attId + '"] .decreaseWords').addEventListener('click', function () {
            RegulatorOperator('-', 'word', loremLang, attId);
        });
    });
};
...
function RegulatorOperator(operator, unit, loremLang, id) {
    ...
    let lorem = Getlorem(loremLang);
    let target = document.querySelector('[data-requlatorId="' + id + '"]');
