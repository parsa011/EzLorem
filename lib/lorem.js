...
function UpdateRegulatorTexts(attrId,itemtext,loremLength){
    ...
    document.querySelector('div[data-requlatorId="' + attrId + '"] .showWrCount').innerHTML = itemtext.split(' ').length - 1;
}   
...
function RegulatorOperator(operator, unit, loremLang,id) {
    ...
    if(document.querySelector('[data-requlatorId="' + id + '"] [data-ezgeneratedtag="true"]') !== undefined){
